...
This package contains components models for fans and pumps.
      ...
      "Fan or pump with ideally controlled normalized speed y as input signal"
        ...
        Modelica.Blocks.Interfaces.RealInput y_in(min=0, max=1)
        ...
        annotation (defaultComponentName="fan",
          Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,-100},
                {100,100}}), graphics={Text(extent={{20,100},{112,78}},
                textString="y_in [0, 1]")}),
          Diagram(coordinateSystem(preserveAspectRatio=true,  extent={{-100,-100},{
                  100,100}}), graphics),
          Documentation(info="<HTML>
...
First implementation.
      ...
      protected
          Buildings.Fluid.Movers.BaseClasses.IdealIsenthalpicSource souDyn(redeclare
            package Medium =   Medium) if                                dynamicBalance
...
for a pressure source or to prescribe a mass flow rate with heat input into the medium.
</p>
</html>"),
        revisions="<html>
<ul>
      ...
      protected
        ...
        equation
          ...
          if control_m_flow then
            ...
            dp = dp_set_internal;
            m_flow_set_internal = 0;
          end if;

          connect(dp_set_internal, dp_in);
          connect(m_flow_set_internal, m_flow_in);

          // Energy balance (no storage, no heat loss/gain)
          port_a.m_flow*port_a.h_outflow + port_b.m_flow*inStream(port_b.h_outflow) = -Q_flow_in;
          port_a.m_flow*port_b.h_outflow + port_b.m_flow*inStream(port_a.h_outflow) =  Q_flow_in;

        end IdealSource;

        model IdealIsenthalpicSource
        "Base class for pressure and mass flow source without heat input"
          extends Modelica.Fluid.Interfaces.PartialTwoPortTransport;
          annotation (Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                    -100},{100,100}}), graphics={
                Rectangle(
            ...
            Documentation(info="<html>
<p>
Model of a fictious isenthalpic pipe that is used as a base class
      ...
      protected
        ...
        //    import Modelica.SIunits.Conversions.NonSIunits.*;
          ...
          parameter Boolean addHeatToMedium=
                              true
          "Set to false to avoid any heat being added to medium (gives simpler equations)";
      protected
...
First implementation.
            ...
            Buildings.Fluid.Sensors.MassFraction Xi_w(redeclare package Medium
              =                                                                  Medium)
