        ...
        protected
          ...
          equation
            ...
            connect(totEntFloRat[i].port_b, bou.ports[i]) annotation (Line(
                points={{-20,6.10623e-16},{-25,6.10623e-16},{-25,9.4369e-16},{
                    -30,9.4369e-16},{-30,0},{-40,0}},
                color={0,127,255},
                smooth=Smooth.None));
            end for;
...
First implementation.
      ...
      public
          ...
          Modelica.Blocks.Interfaces.RealInput phi "Medium relative humidity" 
            annotation (Placement(transformation(extent={{-140,-80},{-100,-40}},
                  rotation=0)));
          Psychrometrics.MassFraction_pTphi masFra(use_p_in=false, redeclare
            package Medium = 
                       Medium) "Mass fraction" 
        ...
        equation
          ...
          connect(senEntFloRat[i].port_a, ports[i]) annotation (Line(
              points={{40,6.10623e-16},{54.5,6.10623e-16},{54.5,-1.60982e-15},{
                  69,-1.60982e-15},{69,-2.22045e-15},{98,-2.22045e-15}},
              color={0,127,255},
              smooth=Smooth.None));
